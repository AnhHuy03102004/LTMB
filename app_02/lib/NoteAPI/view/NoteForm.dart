...
class _NoteFormState extends State<NoteForm> {
  ...
  void initState() {
    ...
    if (widget.note != null) {
      ...
      _priority = note.priority;  // Đảm bảo _priority có giá trị hợp lệ (1, 2, 3)
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (userId == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Không xác định được người dùng, vui lòng đăng nhập')),
        );
        return;
      }
            ...
            children: [
              ...
              DropdownButtonFormField<int>(
                ...
                onChanged: (value) {
                  setState(() {
                    if (value != null) {
                      _priority = value;  // Cập nhật giá trị khi người dùng thay đổi
                    }
                  });
                },
              ),
